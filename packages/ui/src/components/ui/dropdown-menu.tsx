...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "data-[highlighted]:bg-interactive-hover hover:bg-interactive-hover flex cursor-pointer items-center rounded-lg px-2 py-1 typography-ui-label outline-hidden select-none data-[inset]:pl-8",
        className
      )}
      {...props}
    >
