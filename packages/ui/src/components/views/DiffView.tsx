...
type DiffData = { original: string; modified: string; truncated?: boolean };
...
const DiffViewerEntry = React.memo<DiffViewerEntryProps>(({
    ...
    const diffData = React.useMemo(() => {
        ...
        return { original: cachedDiff.original, modified: cachedDiff.modified, truncated: cachedDiff.truncated };
    }, [cachedDiff]);
